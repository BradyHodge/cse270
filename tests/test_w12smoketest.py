...
class TestW12smoketest():
  ...
  def test_w12smoketest(self):
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("BusinessN")
    ...
    self.driver.find_element(By.ID, "username").send_keys("jeff")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("jeffjeff")
